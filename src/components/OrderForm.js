...
const OrderForm = () => {
  ...
  return (
    <FormContainer>
      <FormStyler id="pizza-form" onSubmit={onSubmit}>
        <OrderHeader>
        ...
        <Checkbox className="checkboxes">
          ...
          <label>
            ...
            <textarea name="instructions" id='special-text' rows="4" cols="50"></textarea>
          </label>
          </div>
        </InputFields>
        <SubmitButton id="order-button" disabled={disabled}>submit</SubmitButton>
